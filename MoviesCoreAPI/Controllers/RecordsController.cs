...
namespace MoviesCoreAPI.Controllers
{
    ...
    public class RecordsController : ControllerBase
    {
        ...
        {
            string sqlCustomerInsert = $"INSERT INTO Records (Rate,MovieId,UserId) VALUES ({recordPostDTO.Rate},{recordPostDTO.MovieId},{recordPostDTO.UserId});";
            try
            {
        ...
        public async Task<ActionResult<Records>> DeleteRecord(int id)
        {
            ...
            var movie = await _context.Movies.FindAsync(record.MovieId);
